...
/**
 * Classe base para protocolos Fire-and-Forget (sem resposta)
 * Implementa a lógica completa de conexão e envio
 */
...
/**
 * Classe base para RPCs (com resposta)
